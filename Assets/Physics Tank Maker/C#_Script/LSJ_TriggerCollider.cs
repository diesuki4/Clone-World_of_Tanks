...
public class LSJ_TriggerCollider : MonoBehaviour
{
    /*
    ...
    */
    ...
    List<LSJ_EventTrigger0300TriggerColliderBase> triggerScriptsList = new List<LSJ_EventTrigger0300TriggerColliderBase>();
    ...
    void OnTriggerEnter(Collider collider)
    {
        ...
        if (detectedObject.layer == LSJ_LayerSettings.Body_Layer && Check_DetectedObjects(detectedObject))
    ...
    public void Get_Trigger_Script(LSJ_EventTrigger0300TriggerColliderBase triggerScript)
