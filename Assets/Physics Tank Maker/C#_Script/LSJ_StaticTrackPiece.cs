...
public class LSJ_StaticTrackPiece : MonoBehaviour
{
    /*
    ...
    */
    ...
    public LSJ_StaticTrackParent Parent_Script;
    public int Type; // 0=Static, 1=Anchor, 2=Dynamic.
    public Transform Front_Transform;
    public Transform Rear_Transform;
    public LSJ_StaticTrackPiece Front_Script;
    public LSJ_StaticTrackPiece Rear_Script;
    ...
    { // Called from "Static_Track_Piece_CS" (this).
        ...
        reinforceObject.layer = LSJ_LayerSettings.Reinforce_Layer;
