...
public class LSJ_ArtilleryFire : MonoBehaviour
{
    /*
    ...
    */
    ...
    IEnumerator Create_Shells(Transform targetTransform, int totalShellCount)
    {
        ...
        while (shellCount <= totalShellCount)
        {
            ...
            // Add Scripts
            LSJ_BulletControl bulletScript = shellObject.AddComponent<LSJ_BulletControl>();
            ...
            // Set the layer.
            shellObject.layer = LSJ_LayerSettings.Bullet_Layer;
