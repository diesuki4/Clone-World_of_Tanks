...
public class LSJ_SceneOpen : MonoBehaviour
{
    /*
    ...
    */
    ...
    IEnumerator Open_Scene()
    {
        ...
        if (LSJ_FadeControl.Instance)
        {
            LSJ_FadeControl.Instance.StartCoroutine("Fade_Out");

            // Wait.
            var count = 0.0f;
            while (count < LSJ_FadeControl.Instance.Fade_Time)
            {
