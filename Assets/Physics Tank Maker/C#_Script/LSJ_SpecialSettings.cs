...
public class LSJ_SpecialSettings : MonoBehaviour
{
    /*
    ...
    */
    ...
    protected virtual void Send_Settings()
    {
        ...
        var bulletGeneratorScripts = GetComponentsInChildren<LSJ_BulletGenerator>();
        ...
        var damageControlCenterScript = GetComponentInChildren<LSJ_DamageControlCenter>();
