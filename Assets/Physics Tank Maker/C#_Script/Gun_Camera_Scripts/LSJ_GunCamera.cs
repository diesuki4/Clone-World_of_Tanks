...
public class LSJ_GunCamera : MonoBehaviour
{
    /*
    ...
    */
    ...
    public LSJ_CameraPointsManager Camera_Manager_Script;
    ...
    protected LSJ_GunCameraInput00Base inputScript;
    ...
    void Initialize()
    {
        ...
        {
            Camera_Manager_Script = transform.root.GetComponentInChildren<LSJ_CameraPointsManager>();
        }
        if (Camera_Manager_Script == null)
        {
    ...
    protected virtual void Set_Input_Script(int type)
    {
        switch (type)
        {
            ...
            case 10: // AI.
                inputScript = gameObject.AddComponent<LSJ_GunCameraInput01Mouse>();
                break;

            case 2: // Gamepad (Single stick)
                inputScript = gameObject.AddComponent<LSJ_GunCameraInput02ForSingleStickDrive>();
                break;

            case 3: // Gamepad (Twin sticks)
            case 4: // Gamepad (Triggers)
                inputScript = gameObject.AddComponent<LSJ_GunCameraInput03ForTwinStickDrive>();
                break;
        }
    }
