...
public class LSJ_StaticTrackParent : MonoBehaviour
{
    /*
    ...
    */
    ...
    void Initialize()
    {
        ...
        bodyScript = bodyTransform.GetComponent<LSJ_MainBodySetting>();
        ...
        var staticWheelParentScripts = bodyTransform.GetComponentsInChildren<LSJ_StaticWheelParent>();
