...
public class LSJ_EmissionControl : MonoBehaviour
{
    /*
    ...
    */
    ...
    {
        if (LSJ_MainLightControl.Instance == null)
        {
            return;
        }
        ...
        tempColor.a = Mathf.Lerp(0.0f, tempColor.a, LSJ_MainLightControl.Instance.Main_Light.intensity / Standard_Light_Intensity);
