...
public class LSJ_UILeadMarkerControl : MonoBehaviour
{
    /*
    ...
    */
    ...
    public LSJ_BulletGenerator Bullet_Generator_Script;
    // << User options
    ...
    void Start()
    {
        ...
        aimingScript = GetComponent<LSJ_AimingControl>();
        ...
        {
            Bullet_Generator_Script = GetComponentInChildren<LSJ_BulletGenerator>();
        }
        if (Bullet_Generator_Script == null)
        {
    ...
    void Marker_Control()
    {
        ...
        while (count < Calculation_Time)
        {
            ...
            if (Physics.Linecast(previousPos, currentPos, out RaycastHit raycastHit, LSJ_LayerSettings.Aiming_Layer_Mask))
            {
