...
public class LSJ_RespawnController : MonoBehaviour
{
    /*
    ...
    */
    ...
    void Update()
    {
        ...
        if (LSJ_GeneralSettings.Allow_Manual_Respawn)
        {
            Manual_Respawn();
        }
    }
    ...
    void Manual_Respawn()
    {
        ...
        if (Input.GetKeyDown(LSJ_GeneralSettings.Respawn_Key))
        {
    ...
    bool Detect_Tank()
    {
        ...
        // Check the tank around the spawning point.
        Collider[] colliders = Physics.OverlapSphere(respawnPos, 5.0f, LSJ_LayerSettings.Detect_Body_Layer_Mask);
