...
public class LSJ_MenuDictionary : MonoBehaviour
{
    /*
    ...
    */
    ...
    protected List<LSJ_MenuDropdown> dropdownScriptsList = new List<LSJ_MenuDropdown>();
    protected List<LSJ_MenuSlider> attackSliderScriptsList = new List<LSJ_MenuSlider>();
    protected List<LSJ_MenuSlider> defenceSliderScriptsList = new List<LSJ_MenuSlider>();
    ...
    public static LSJ_MenuDictionary Instance;
    ...
    public void Get_Dropdown_Script(LSJ_MenuDropdown dropdownScript)
    { // Called from "Menu_Dropdown_CS" before "Awake()" of this script.
        dropdownScriptsList.Add(dropdownScript);
    }


    public void Get_Attack_Slider_Script(LSJ_MenuSlider sliderScript)
    { // Called from "Menu_Slider_CS" before "Awake()" of this script.
        attackSliderScriptsList.Add(sliderScript);
    }


    public void Get_Defence_Slider_Script(LSJ_MenuSlider sliderScript)
    { // Called from "Menu_Slider_CS" before "Awake()" of this script.
    ...
    protected virtual void Overwrite_Values()
    {
        ...
        var eventScripts = FindObjectsOfType<LSJ_EventController>();
