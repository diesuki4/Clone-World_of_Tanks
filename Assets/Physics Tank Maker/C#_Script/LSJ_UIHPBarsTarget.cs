...
public class LSJ_UIHPBarsTarget : MonoBehaviour
{
    /*
    ...
    */
    ...
    LSJ_DamageControlCenter targetDamageScript;


    public static LSJ_UIHPBarsTarget Instance;
    ...
    void Update_Traget_Information()
    {
        ...
        targetDamageScript = currentTargetRigidbody.GetComponentInParent<LSJ_DamageControlCenter>();
        if (targetDamageScript == null)
        {
            return;
        }
        ...
        // Set the color.
        var targetIDScript = currentTargetRigidbody.GetComponentInParent<LSJ_IDSettings>();
        if (targetIDScript)
        {
    ...
    public void Get_Aiming_Script(LSJ_AimingControl tempAimingScript)
