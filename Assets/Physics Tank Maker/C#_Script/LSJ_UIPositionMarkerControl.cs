...
public class LSJ_UIPositionMarkerControl : MonoBehaviour
{
    /*
    ...
    */
    ...
    Dictionary<LSJ_IDSettings, Position_Marker_Prop> markerDictionary = new Dictionary<LSJ_IDSettings, Position_Marker_Prop>();
    Canvas canvas;
    ...
    { // Called from "ID_Settings_CS" in tanks in the scene, when the tank is spawned.
        ...
        newProp.AI_Script = idScript.GetComponentInChildren<LSJ_AI>();
        ...
        for (int i = 0; i < idScriptsList.Count; i++)
        {
            ...
            { // The reference to the MainBody has been lost. >> The tank has been respawned.
              // Get the new references to the "MainBody" and "AI_CS".
                ...
                markerDictionary[idScriptsList[i]].AI_Script = idScriptsList[i].GetComponentInChildren<LSJ_AI>();
            }
    ...
    void Remove_ID(LSJ_IDSettings idScript)
