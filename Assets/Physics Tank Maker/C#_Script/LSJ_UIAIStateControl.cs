...
public class LSJ_UIAIStateControl : MonoBehaviour
{
    /*
    ...
    */
    ...
    Text thisText;
    LSJ_AI aiScript;
    LSJ_RespawnController respawnScript;
    ...
    public void Get_AI_Script(LSJ_AI aiScript)
    { // Called form "AI_CS" in the AI tanks in the scene.
        ...
        respawnScript = aiScript.GetComponentInParent<LSJ_RespawnController>();
