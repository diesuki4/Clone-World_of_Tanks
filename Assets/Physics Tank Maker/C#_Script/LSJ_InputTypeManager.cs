...
public class LSJ_InputTypeManager : MonoBehaviour
{
    /*
    ...
    */
    ...
    {
        // Overwrite the values in "General_Settings_CS".
        LSJ_GeneralSettings.Input_Type = Input_Type;
    }
    ...
    protected virtual void Set_Cursor_State()
    {
        ...
        switch (LSJ_GeneralSettings.Input_Type)
        {
