...
public class LSJ_AIShareTarget : MonoBehaviour
{
    /*
    ...
    public LSJ_AI AI_Script; // Set by "AI_CS".

    int thisRelationship;
    LSJ_AimingControl commanderAimingScript;
    ...
    void Initialize()
    {
        ...
        var idScript = GetComponentInParent<LSJ_IDSettings>();
        thisRelationship = idScript.Relationship;

        // Get "Aiming_Control_CS" in the commander.
        commanderAimingScript = AI_Script.Settings_Script.Commander.GetComponentInChildren<LSJ_AimingControl>();
    ...
    {
        var targetIDScript = commanderAimingScript.Target_Transform.GetComponentInParent<LSJ_IDSettings>();
        if (targetIDScript)
        {
    ...
    void Share_Target()
    {
        ...
        LSJ_AIHeadquatersHelper targetAIHelperScript = commanderAimingScript.Target_Transform.GetComponentInParent<LSJ_AIHeadquatersHelper>();
