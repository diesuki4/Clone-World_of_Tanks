...
public class LSJ_EventController : MonoBehaviour
{
    /*
    ...
    */
    ...
    public LSJ_TriggerCollider[] Trigger_Collider_Scripts;
    public int Useless_Event_Num;
    public LSJ_EventController[] Useless_Events;
    public int Disabled_Event_Num;
    public LSJ_EventController[] Disabled_Events;
    ...
    public LSJ_ArtilleryFire Artillery_Script;
    ...
    public LSJ_EventTrigger00Base Trigger_Script; // Controlled by trigger scripts.
    protected LSJ_EventEvent00Base eventScript;
    ...
    protected void Set_Trigger_Script()
    {
        ...
        {
            case 0: // Timer
                Trigger_Script = gameObject.AddComponent<LSJ_EventTrigger01Timer>();
                break;
            ...
            case 1: // Destroy
                switch (Operator_Type)
                {
                    case 0: // AND
                        if (All_Trigger_Flag)
                        {
                            Trigger_Script = gameObject.AddComponent<LSJ_EventTrigger0201DestroyANDAll>();
                        }
                        else
                        {
                            Trigger_Script = gameObject.AddComponent<LSJ_EventTrigger0202DestroyANDNecessary>();
                        }
                        break;

                    case 1: // OR
                        Trigger_Script = gameObject.AddComponent<LSJ_EventTrigger0203DestroyOR>();
                        break;
                }
                break;
            ...
            case 2: // Trigger_Collider
                switch (Trigger_Setting_Type)
                {
                    case 0: // 'Set manually'
                        ...
                        {
                            case 0: // AND
                                Trigger_Script = gameObject.AddComponent<LSJ_EventTrigger0301TriggerColliderAND>();
                                break;
                            case 1: // OR
                                Trigger_Script = gameObject.AddComponent<LSJ_EventTrigger0302TriggerColliderOR>();
                                break;
                        }
                        break;
                    ...
                    case 3: // "Any tank"
                        Trigger_Script = gameObject.AddComponent<LSJ_EventTrigger0303TriggerColliderAny>();
                        break;
                }
                break;
        }
    ...
    protected void Set_Event_Script()
    {
        ...
        {
            case 0: // Spawn Tank
                eventScript = gameObject.AddComponent<LSJ_EventEvent01SpawnTank>();
                break;

            case 1: // Show Message
                eventScript = gameObject.AddComponent<LSJ_EventEvent02ShowMessage>();
                break;

            case 2: // Change AI Settings
                eventScript = gameObject.AddComponent<LSJ_EventEvent03ChangeAISettings>();
                break;

            case 3: // Remove Tank
                eventScript = gameObject.AddComponent<LSJ_EventEvent04RemoveTank>();
                break;

            case 4: // Artillery Fire
                eventScript = gameObject.AddComponent<LSJ_EventEvent05ArtilleryFire>();
                break;

            case 5: // Destroy Tank
                eventScript = gameObject.AddComponent<LSJ_EventEvent06DestroyTank>();
                break;

            case 6: // Show Result Canvas
                eventScript = gameObject.AddComponent<LSJ_EventEvent07ShowResultCanvas>();
                break;
    ...
    public void Overwrite_Values(LSJ_EventController eventScript)
