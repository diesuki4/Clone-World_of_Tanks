...
public class LSJ_EventTrigger0303TriggerColliderAny : LSJ_EventTrigger0300TriggerColliderBase
{
    ...
    { // Called from "Trigger_Collider_CS".
      // Find "ID_Settings_CS" script in the "detectedTransform".
        LSJ_IDSettings idScript = detectedTransform.GetComponentInChildren<LSJ_IDSettings>();
        if (idScript == null)
        {
            return;
        }
