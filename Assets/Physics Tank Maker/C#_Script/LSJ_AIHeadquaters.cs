...
public class LSJ_AIHeadquaters : MonoBehaviour
{
    /*
    ...
    */
    ...
    public List<LSJ_AIHeadquatersHelper> Friendly_Tanks_List = new List<LSJ_AIHeadquatersHelper>();
    public List<LSJ_AIHeadquatersHelper> Hostile_Tanks_List = new List<LSJ_AIHeadquatersHelper>();

    float orderCount;


    public static LSJ_AIHeadquaters Instance;
    ...
    public void Receive_Helpers(LSJ_AIHeadquatersHelper helperScript)
    ...
    void Assign_Target(List<LSJ_AIHeadquatersHelper> teamA, List<LSJ_AIHeadquatersHelper> teamB)
    {
        // Assign the target to all the AI tanks in the scene.
    ...
    public void Remove_From_List(LSJ_AIHeadquatersHelper helperScript)
