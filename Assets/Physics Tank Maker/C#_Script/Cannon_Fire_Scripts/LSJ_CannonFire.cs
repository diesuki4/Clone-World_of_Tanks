...
public class LSJ_CannonFire : MonoBehaviour
{
    /*
    ...
    */
    ...
    public LSJ_BulletGenerator[] Bullet_Generator_Scripts; // Referred to from "Cannon_Fire_Input_##_###".
    LSJ_RecoilBrake[] recoilScripts;

    protected LSJ_CannonFireInput00Base inputScript;
    ...
    { // This function must be called in Start() after changing the hierarchy.
        ...
        Bullet_Generator_Scripts = GetComponentsInChildren<LSJ_BulletGenerator>();
        recoilScripts = thisTransform.parent.GetComponentsInChildren<LSJ_RecoilBrake>();
    ...
    protected virtual void Set_Input_Script(int type)
    {
        switch (type)
        {
            ...
            case 1: // Mouse + Keyboard (Pressing)
                inputScript = gameObject.AddComponent<LSJ_CannonFireInput01Mouse>();
                break;

            case 2: // GamePad (Single stick)
            case 3: // GamePad (Twin stick)
                inputScript = gameObject.AddComponent<LSJ_CannonFireInput02ForSticksDrive>();
                break;

            case 4: // GamePad (Triggers)
                inputScript = gameObject.AddComponent<LSJ_CannonFireInput03ForTriggersDrive>();
                break;

            case 10: // AI
                inputScript = gameObject.AddComponent<LSJ_CannonFireInput99AI>();
                break;
        }
    }
