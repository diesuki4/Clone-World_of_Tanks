...
public class LSJ_UIAimMarkerControl : MonoBehaviour
{
    /*
    ...
    void Marker_Control()
    {
        ...
        { // Not locking on now.
            ...
            { // Not using the gun camera now.
                ...
                markerTransform.position = new Vector3(Screen.width * 0.5f, Screen.height * (0.5f + LSJ_GeneralSettings.Aiming_Offset), 128.0f);
            }
        }
    }
