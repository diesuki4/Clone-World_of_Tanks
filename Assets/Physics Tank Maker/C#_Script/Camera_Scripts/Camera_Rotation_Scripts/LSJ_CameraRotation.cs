...
public class LSJ_CameraRotation : MonoBehaviour
{
    /*
    ...
    */
    ...
    protected LSJ_CameraRotationInput00Base inputScript;
    ...
    protected virtual void Set_Input_Script(int type)
    {
        switch (type)
        {
            ...
            case 10: // AI.
                inputScript = gameObject.AddComponent<LSJ_CameraRotationInput01Mouse>();
                break;

            case 2: // Gamepad (Single stick)
            case 4: // Gamepad (Triggers)
                inputScript = gameObject.AddComponent<LSJ_CameraRotationInput02ForSingleStickDrive>();
                break;

            case 3: // Gamepad (Twin sticks)
                inputScript = gameObject.AddComponent<LSJ_CameraRotationInput03ForTwinSticksDrive>();
                break;

            case 99: // Demo.
                inputScript = gameObject.AddComponent<LSJ_CameraRotationInput99Demo>();
                break;
        }
    }
    ...
    void Update()
    {
        ...
        if (LSJ_GeneralSettings.Camera_Invert_Flag)
        {
    ...
    void Rotate_TPV()
    {
        ...
        targetAngles.y += Horizontal_Input * LSJ_GeneralSettings.Camera_Horizontal_Speed;
        targetAngles.z -= Vertical_Input * LSJ_GeneralSettings.Camera_Vertical_Speed;

        // Clamp the angles.
        if (LSJ_GeneralSettings.Camera_Use_Clamp)
        {
    ...
    void Rotate_FPV()
    {
        ...
        // Vertical rotation.
        if (LSJ_GeneralSettings.Camera_Simulate_Head_Physics)
        {
    ...
    { // Called from "Aiming_Control_CS".
        ...
        switch (currentCameraPoint.Rotation_Type)
        {
            ...
            case 1: // Third person view.
                ...
                targetAngles.z += Main_Camera.fieldOfView * LSJ_GeneralSettings.Aiming_Offset;
                break;
