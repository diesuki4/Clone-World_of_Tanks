...
public class LSJ_CameraZoom : MonoBehaviour
{
    ...
    */
    ...
    protected LSJ_CameraZoomInput00Base inputScript;
    ...
    protected virtual void Set_Input_Script(int type)
    {
        switch (type)
        {
            ...
            case 10: // AI.
                inputScript = gameObject.AddComponent<LSJ_CameraZoomInput01Mouse>();
                break;

            case 2: // Gamepad (Single stick)
            case 3: // Gamepad (Twin sticks)
            case 4: // Gamepad (Triggers)
                inputScript = gameObject.AddComponent<LSJ_CameraZoomInput02GamePad>();
                break;
        }
    }
