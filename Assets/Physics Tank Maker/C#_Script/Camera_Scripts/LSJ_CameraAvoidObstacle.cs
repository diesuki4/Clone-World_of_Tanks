...
public class LSJ_CameraAvoidObstacle : MonoBehaviour
{
    /*
    ...
    */
    ...
    void Avoid_Obstacle()
    {
        ...
        RaycastHit[] raycastHits = Physics.RaycastAll(ray, thisTransform.localPosition.x + 1.0f, LSJ_LayerSettings.Layer_Mask);
        for (int i = 0; i < raycastHits.Length; i++)
        {
            ...
            { // The hit object is not myself.
                ...
                { // Not avoiding now.
                    ...
                    if (hittingTime > LSJ_GeneralSettings.Camera_Avoid_Lag)
                    {
                        ...
                        targetDistance = Mathf.Clamp(targetDistance, LSJ_GeneralSettings.Camera_Avoid_Min_Dist, LSJ_GeneralSettings.Camera_Avoid_Max_Dist);
                    }
                } // Avoiding now.
    ...
    void Move()
    {
        ...
        {
            currentDistance = Mathf.MoveTowards(currentDistance, targetDistance, LSJ_GeneralSettings.Camera_Avoid_Move_Speed * Time.fixedDeltaTime);
