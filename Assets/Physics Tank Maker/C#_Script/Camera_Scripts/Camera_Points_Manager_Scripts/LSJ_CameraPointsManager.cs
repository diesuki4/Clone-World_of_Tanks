...
public class LSJ_CameraPointsManager : MonoBehaviour
{
    /*
    ...
    */
    ...
    protected LSJ_CameraPointsManagerInput00Base inputScript;
    ...
    protected virtual void Set_Input_Script(int type)
    {
        switch (type)
        {
            ...
            case 10: // AI.
                inputScript = gameObject.AddComponent<LSJ_CameraPointsManagerInput01Mouse>();
                break;

            case 2: // Gamepad (Single stick)
            case 3: // Gamepad (Twin sticks)
            case 4: // Gamepad (Triggers)
                inputScript = gameObject.AddComponent<LSJ_CameraPointsManagerInput02Gamepad>();
                break;
        }
    }
