...
public class LSJ_MenuSlider : MonoBehaviour
{
    /*
    ...
    */
    ...
    {
        // Send this reference to "Menu_Dictionary_CS".
        if (LSJ_MenuDictionary.Instance)
        {
            switch (Type)
            {
                case 0: // for Attack Multiplier.
                    LSJ_MenuDictionary.Instance.Get_Attack_Slider_Script(this);
                    break;

                case 1: // for Defence Multiplier.
                    LSJ_MenuDictionary.Instance.Get_Defence_Slider_Script(this);
                    break;
            }
        }
    }
    ...
    { // Called from the slider, when the value has been changed.
        ...
        if (LSJ_MenuDictionary.Instance)
        {
            LSJ_MenuDictionary.Instance.Update_Slider_Disctionary(Type, Key_Name, This_Slider.value);
        }
    }
}
