...
public class LSJ_BulletGenerator : MonoBehaviour
{
    /* 
    ...
    */
    ...
    IEnumerator Generate_Bullet()
    {
        ...
        LSJ_BulletControl bulletScript = bulletObject.GetComponent<LSJ_BulletControl>();
        ...
        // Set the layer.
        bulletObject.layer = LSJ_LayerSettings.Bullet_Layer;
