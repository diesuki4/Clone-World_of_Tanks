...
public class LSJ_IDSettings : MonoBehaviour
{
    /*
    ...
    */
    ...
    { // This function must be called in Start(). Because this variables might be overwritten by "Event_Controller_CS" in the Awake().
        ...
        if (LSJ_IDManager.Instance)
        {
            // Also, the proper ID is set by "ID_Manager_CS",
            LSJ_IDManager.Instance.SendMessage("Receive_ID_Script", this, SendMessageOptions.DontRequireReceiver);
        }
    ...
    { // Called from "Respawn_Controller_CS", just before the tank is removed.
        ...
        if (LSJ_IDManager.Instance)
        {
            LSJ_IDManager.Instance.SendMessage("Remove_ID", this, SendMessageOptions.DontRequireReceiver);
        }
    }
