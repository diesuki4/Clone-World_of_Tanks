...
public class LSJ_GameController : MonoBehaviour
{
    /*
    ...
    */
    ...
    List<LSJ_IDSettings> idScriptsList = new List<LSJ_IDSettings>();
    bool isPaused;
    bool storedCursorVisible;


    public static LSJ_GameController Instance;
    ...
    void Start()
    {
        ...
        // Layer settings.
        LSJ_LayerSettings.Layers_Collision_Settings();
    ...
    void Receive_ID_Script(LSJ_IDSettings idScript)
    ...
    void General_Functions()
    {
        ...
        // Reload the scene.
        if (LSJ_GeneralSettings.Allow_Reload_Scene && Input.GetKeyDown(LSJ_GeneralSettings.Reload_Scene_Key))
        {
            Time.timeScale = 1.0f;
        ...
        // Quit.
        if (LSJ_GeneralSettings.Allow_Instant_Quit && Input.GetKeyDown(LSJ_GeneralSettings.Quit_Key))
        {
            Application.Quit();
            return;
        }
        ...
        // Cursor state.
        if (LSJ_GeneralSettings.Allow_Switch_Cursor && Input.GetKeyDown(LSJ_GeneralSettings.Switch_Cursor_Key))
        {
        ...
        // Pause.
        if (Allow_Pause && Input.GetKeyDown(LSJ_GeneralSettings.Pause_Key))
        {
            Pause();
            return;
        }
    ...
    public void Remove_ID(LSJ_IDSettings idScript)
