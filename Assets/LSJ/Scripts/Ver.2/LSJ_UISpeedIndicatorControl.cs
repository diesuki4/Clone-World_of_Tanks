...
public class LSJ_UISpeedIndicatorControl : MonoBehaviour
{
    /*
    ...
    */
    ...
    public static LSJ_UISpeedIndicatorControl Instance;
    ...
    public void Get_Drive_Script(LSJ_DriveControl driveScript, bool isManual, int currentStep)
    { // Called from "Drive_Control_CS".
        isWorking = true;
